...
# https://github.com/tensorflow/minigo/blob/master/go.py
...
class Position():
    ...
    def __init__(self, board: np.ndarray, n=0, komi=3.5, caps=(0, 0),
        ...
        self.komi = komi
        self.caps = caps
        self.lib_tracker = lib_tracker if lib_tracker is not None else LibertyTracker(N).from_board(self.board)
        self.ko = ko
        self.recent = recent
        self.last = last
